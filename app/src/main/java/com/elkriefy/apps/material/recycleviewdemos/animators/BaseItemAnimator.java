package com.elkriefy.apps.material.recycleviewdemos.animators;
...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
    ...
    protected abstract void animateRemoval(final RecyclerView.ViewHolder holder);
